            ...
            <Box mt={'40px'} id={'../components/....'} >
                <Flex align="center" flexDir={{ base: "column", md: "row", lg: 'row' }}>
                    <Flex direction={{ base: 'column', md: 'row' }} p={5} align={'center'}
                        ...
                        <Box w={{ base: '250px', md: '500px' }}><Img src='/web.jpg'
                            alt="" width={'100%'} h={'100%'} objectFit={'contain'} />  </Box>
                        <Box align={'center'} w={{ base: '100%', md: '100%' }}>
                            <Text fontFamily={'sans-serif'} align={'center'} borderBottom={'1px solid red'}
                                ...
                                WEB DESIGN</Text>
                            <Text lineHeight={'40px'} fontFamily={'sans-serif'} color={'#33334d'} 
                            mt={'20px'} fontSize={{ base: '25', lg: '32' }} w={{ base: '100%', lg: '75%' }}>
                                ...
                                link while we can set up an <b>attractive website for you</b> and
                                 drive your targets in making a  <b> BOOM in your business!</b> </Text>
                        </Box>
